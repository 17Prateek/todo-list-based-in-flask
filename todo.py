...
# Corrected the configuration key name
...
with app.app_context():
    db.create_all()  # Fixed typo here (added parentheses to call the function)
...
def index(todo_id=None):
    ...
    todos = Todo.query.order_by(Todo.id.desc()).all()  # Fixed typo here (changed 'dese' to 'desc')
    return render_template('todo_index.html', todos=todos,todo=todo)
